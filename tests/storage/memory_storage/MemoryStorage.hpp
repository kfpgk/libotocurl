#ifndef LIBOTOCURL_TESTS_CURL_STORAGE_MEMORY_STORAGE_MEMORY_STORAGE_HPP
#define LIBOTOCURL_TESTS_CURL_STORAGE_MEMORY_STORAGE_MEMORY_STORAGE_HPP
...
namespace otocurl::integration_test::storage::memory_storage {
    ...
    class MemoryStorage : public cpptest::integration_test::MultiTest {
    ...
    private:
        ...
        std::unique_ptr<otocurl::storage::MemoryStorageHandle> dataHandle1;
        std::unique_ptr<otocurl::storage::MemoryStorageHandle> dataHandle2;            
