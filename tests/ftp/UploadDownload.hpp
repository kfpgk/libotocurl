#ifndef LIBOTOCURL_TESTS_CURL_FTP_UPLOAD_DOWNLOAD_HPP
#define LIBOTOCURL_TESTS_CURL_FTP_UPLOAD_DOWNLOAD_HPP
...
namespace otocurl::integration_test::ftp {
    ...
    class UploadDownload : public cpptest::integration_test::MultiTest {
